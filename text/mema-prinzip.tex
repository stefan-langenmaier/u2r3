...
\begin{itemize}
  ...
  \item Umwandlung gewisser Konstrukte. Es wird außerdem vorgeschlagen manche Konstrukte umzuwandeln. So z.B. A subsumiert B int C ==> A subsumes B, A subsumes C
