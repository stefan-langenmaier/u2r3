...
\begin{center}
	\begin{tikzpicture}[node distance=3cm]
		...
		\node (differentFromEnt) [relation, rectangle split, rectangle split parts=2, below of= negativeObjectPropertyAssertion]{
