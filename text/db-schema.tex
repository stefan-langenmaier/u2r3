...
\begin{figure}
	\caption{sonstige Relationen (fortgesetzt)}
	\label{relations-other-2}
	\begin{tikzpicture}[node distance=5cm]
		...
		\node (differentFromLit) [relation, rectangle split, rectangle split parts=2, right =2cm of differentFromEnt]{
		...
		\node (propertyDisjointWith) [relation, rectangle split, rectangle split parts=2, right =2cm of disjointWith]{
				\textbf{propertyDisjointWith}
			\nodepart{second}
				id: INT\newline
				\textbf{\underline{left}}: PROPERTY\newline
	...
	\end{tikzpicture}
\end{figure}
Die sonstige Relationen aus Abbildung \ref{relations-others-1} und \ref{relations-other-2} sind so umfangreich, da in OWL2 RL fast die komplette Sprachmächtigkeit von OWL2 abbildbar ist.
