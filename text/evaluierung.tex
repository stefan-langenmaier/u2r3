...
Die DomusAG-Ontologie [\ref{table-time-domusag}] benutzt Konstrukte, die in OWL2 RL nicht erlaubt sind. Mit einer Konfigurationsoption kann man aber extra Regeln in u2r3 aktivieren, damit er damit umgehen kann.
\begin{table}[htbp]
...
Die VAST2009-tiny Ontologie [\ref{table-time-vast-tiny}] ist eine verkleinerte Version der VAST2009-Ontologie. Sie enthält eine große Anzahl an Beziehungen (data- und objectPropertyAssertion) und ist daher das angestrebte Einsatzgebiet von OWL2 RL und damit u2r3.
...
Die VAST2009-Ontologie [\ref{table-time-vast2009}] enthält jetzt die volle Anzahl an Individuen und Beziehungen.
