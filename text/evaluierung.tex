...
\multicolumn{1}{|l|}{Pellet\tnote{f}} & 2s & 7ms & 0s & 0ms & 1ms & 1ms \\ \hline
...
\multicolumn{1}{|l|}{Pellet} & 4s & 8ms & 0ms & 1ms & 0ms & 1ms \\ \hline
\multicolumn{1}{|l|}{Racer} & 2s & 3ms & 6ms & 1ms & 4ms & 1ms \\ \hline
\multicolumn{1}{|l|}{Fact++\tnote{b}} & 3s & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
\multicolumn{1}{|l|}{OWLim} & 4s & 400ms & 2516ms & 411ms & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
\end{tabular}
\begin{tablenotes}
	\item[a] unsupported datatype
	\item[b] unknown class
\end{tablenotes}
\end{threeparttable}
\end{center}
\end{table}
...
\multicolumn{1}{|l|}{Pellet\tnote{b}} & 2s & 7ms & 0s & 1ms & 0s & 0ms \\ \hline
\multicolumn{1}{|l|}{Racer\tnote{c}} & 1s & 3ms & 2ms & 4ms & 4ms & 1ms \\ \hline
\multicolumn{1}{|l|}{Fact++\tnote{d}} & 1s & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
...
\multicolumn{1}{|l|}{HermiT\tnote{a}} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
\multicolumn{1}{|l|}{Pellet\tnote{b}} & 11s & 14ms & 0s & 1ms & 0s & 1ms \\ \hline
\multicolumn{1}{|l|}{Racer\tnote{c}} & 11s & 2s & 0s & 2ms & 0s & 2ms \\ \hline
...
\multicolumn{1}{|l|}{Pellet\tnote{b}} & 3s & 10ms & 1ms & 1ms & 1ms & 9ms \\ \hline
\multicolumn{1}{|l|}{Racer\tnote{c}} & 2s & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
...
\begin{tablenotes}
	...
	\item[b] aber falsch
	\item[c] undefined concept
	\item[d] unable to register concept
\end{tablenotes}
\end{threeparttable}
\end{center}
\end{table}
...
\multicolumn{1}{|l|}{Pellet\tnote{b}} & 7s & 7ms & 0s & 1ms & 1ms & 1ms \\ \hline
\multicolumn{1}{|l|}{Racer\tnote{c}} & 6s & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
\multicolumn{1}{|l|}{Fact++\tnote{d}} & 7s & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} & \multicolumn{1}{c|}{x} \\ \hline
