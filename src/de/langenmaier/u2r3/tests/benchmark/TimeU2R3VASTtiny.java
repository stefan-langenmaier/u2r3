...
public class TimeU2R3VASTtiny {
	...
	public static void main(String[] args) {
		try {
			...
			Logger logger = Logger.getLogger(TimeU2R3VASTtiny.class);
			logger.info("Java loaded ");

			String file_uri = "file:///home/stefan/.workspace/u2r2/ontologien/owl2rl/VAST2009-tiny-RL.owl";
			String ONTO_URI = "http://www.informatik.uni-ulm.de/ki/Liebig/owl/VAST2009-tiny-RL.owl#";
