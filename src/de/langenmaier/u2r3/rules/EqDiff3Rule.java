...
public class EqDiff3Rule extends ConsistencyRule {
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		sql.append("\n\t INNER JOIN " + delta.getDeltaName("distinctMembers") + " AS m ON clsA.class = m.class");
	...
	public String toString() {
		return "FALSE :- classAssertion(X, alldifferent), distinctMembers(X, Y), list(Y, Z1..Zn), sameAs(Zi, Zj)";
	}
