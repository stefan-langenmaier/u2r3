...
public class ClsMaxc2LitRule extends ApplicationRule {
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		if (run == 0) {
			sql.append("\n\t\t INNER JOIN " + delta.getDeltaName("dataPropertyAssertion") + " AS prp1 ON ca.class = prp1.subject AND op.property = prp1.property");
			sql.append("\n\t\t INNER JOIN dataPropertyAssertion AS prp2 ON ca.entity = prp2.subject AND op.entity = prp2.property");
		} else if (run == 1) {
