...
public class ScmOpEqRule extends ApplicationRule {
	static Logger logger = Logger.getLogger(ScmOpEqRule.class);
	
	ScmOpEqRule(U2R3Reasoner reasoner) {
		super(reasoner);
	...
	public String toString() {
		return "equivalentProperty(A,A) :- classAssertionEnt(A,objProp)";
	}
