...
public class CaxEqc1LitRule extends ApplicationRule {
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		if (settings.getDeletionType() == DeletionType.CASCADING) {
			...
			sql.append("\n\t SELECT DISTINCT clsA.literal, ec.right");
		}
		...
		if (again) {
			...
			sql.append("\n\t\t WHERE bottom.literal = clsA.literal AND bottom.class = ec.right");
			sql.append("\n\t )");
		}
		sql.append("\n\t  GROUP BY clsA.literal, ec.right");
		return sql.toString();
	}
