...
public class EqRefPEntRule extends ApplicationRule {
	static Logger logger = Logger.getLogger(EqRefPEntRule.class);
	
	EqRefPEntRule(U2R3Reasoner reasoner) {
		super(reasoner);
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		if (again) {
			...
			sql.append("\n\t\t WHERE bottom.colLeft = top.property AND bottom.right = top.property");
			sql.append("\n\t )");
		}
		sql.append("\n\t GROUP BY property");
		return sql.toString();
	...
	public String toString() {
		return "sameAsEnt(A,A) :- objectPropertyAssertion(S, A, O)";
	}
