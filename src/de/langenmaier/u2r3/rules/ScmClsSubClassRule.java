...
public class ScmClsSubClassRule extends ApplicationRule {
	...
	ScmClsSubClassRule(U2R3Reasoner reasoner) {
		super(reasoner);
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		if (again) {
			...
			sql.append("\n\t\t WHERE bottom.sub = clsA.entity AND bottom.super = clsA.entity");
			sql.append("\n\t )");
		}
	...
	public String toString() {
		return "subClass(C, C) :- classAssertionEnt(C, class)";
	}
