...
public class ImplDpaRule extends ApplicationRule {
	static Logger logger = Logger.getLogger(ImplSvfRule.class);
	
	ImplDpaRule(U2R3Reasoner reasoner) {
		super(reasoner);
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		sql.append("\n\t FROM " + delta.getDeltaName("dataProperty") + " AS ndpa");
	...
	public String toString() {
		return "classAssertionEnt(X, DatatypeProperty) :- dataPropertyAssertion(S, X, O)";
	}
