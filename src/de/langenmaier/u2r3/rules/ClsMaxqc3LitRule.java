...
public class ClsMaxqc3LitRule extends ApplicationRule {
	...
	protected String buildQuery(DeltaRelation delta, DeltaRelation newDelta,
		...
		if (run == 0) {
			...
			sql.append("\n\t\t INNER JOIN classAssertionLit AS ca2 ON ca2.class = prp1.subject AND ca2.type = oc.class");
			sql.append("\n\t\t INNER JOIN dataPropertyAssertion AS prp2 ON ca1.class = prp2.subject AND op.property = prp2.property");
			sql.append("\n\t\t INNER JOIN classAssertionlit AS ca3 ON ca3.class = prp1.subject AND ca3.type = oc.class");
		} else if (run == 1) {
